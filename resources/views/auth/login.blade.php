                ...
                <div class="row justify-content-md-center">
                    <div class="col-lg-4">
                        ...
                        <div class="customer-login text-left">
                            ...
                            <input type="text" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Tulis Email" name="email"
                                value="{{ old('email') }}">
                            <input id="password" type="password" name="password"
                                class="form-control @error('password') is-invalid @enderror" placeholder="Tulis Password">
